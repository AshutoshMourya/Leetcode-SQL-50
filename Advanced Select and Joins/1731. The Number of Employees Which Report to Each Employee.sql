...
create table Employees2 (employee_id int,  name    varchar(20), reports_to int,  age int)
...
cast(sum(e1.age)*1.0/count(e1.reports_to) as Decimal(10,0))as 'average_age'
from Employees e1
...
(
    ...
    ROUND(AVG(CONVERT(FLOAT,age)),0) as average_age
    FROM Employees
    GROUP BY reports_to
) t
JOIN Employees E
